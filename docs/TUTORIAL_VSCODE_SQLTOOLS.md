...
> [README](../README.md)). PostgreSQL queda publicado en `localhost:15454`.
...
| Port | `15454` | El puerto del host del compose (`15454:1433`) |
...
> El puerto es la clave: **15454, no 1433**. Dentro de la red de Docker
> la BD escucha en 1433, pero hacia su PC el compose la publica en 15454
...
>
> ```
> Error opening connection Failed to connect to localhost:15454
...
> (`http://localhost:8054/api/producto/PR009`) — un solo dato, muchos
> clientes.
...
| 1 | Crear la conexión (localhost:15454) con test y guardarla |
