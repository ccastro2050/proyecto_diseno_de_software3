...
2. **Copie las specs de la v2** desde el clon del curso (los 7 `.md` +
   ...
   ```powershell
   Copy-Item ..\proyecto_diseno_de_software3\docs\spec_kit\versiones\v2_persona_factura\* docs\spec_kit\versiones\v2_persona_factura\
   ```
...
7. Mi proyecto corre con los puertos de la v1 desplazados +100 (convivo
   con el clon del curso): API en 8154 y PostgreSQL en 15554, con
   name: mi_v1_producto en el compose. Cuando me des URLs o comandos de
   prueba, usa localhost:8154 y localhost,15554.
...
3. **El cierre es doble**: primero la REGRESIÓN de la v1 (su smoke test
   ...
   puertos: donde el quickstart diga `8054` use `8154`.
